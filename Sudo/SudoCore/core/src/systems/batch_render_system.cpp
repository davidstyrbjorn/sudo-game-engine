...
namespace sudo { namespace sudo_system { 
	...
	void BatchRendererSystem::Start()
	{
		...
		m_shader = new graphics::Shader("D:\\SudoGameEngine\\Sudo\\SudoCore\\core\\src\\shaders\\unlit_shader_vertex.txt", "D:\\SudoGameEngine\\Sudo\\SudoCore\\core\\src\\shaders\\shader_fragment.txt");
		m_shader->enable();
