...
namespace sudo { namespace system {
	...
	void RenderSystem::Start()
	{
		...
		m_shader = new graphics::Shader("C:\\SudoGameEngine\\Sudo\\SudoCore\\core\\src\\unlit_shader_vertex.txt", "C:\\SudoGameEngine\\Sudo\\SudoCore\\core\\src\\unlit_shader_fragment.txt");
		m_shader->enable();
